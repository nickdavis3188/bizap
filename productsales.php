...
<div id="main_container">
    ...
    <div class="right_content">            
     <h1>  Sales Report for a Specific Product</h1>   
     
<h2>     Select the product<br />
  <br />
<br />
<center>
...
<form id="myform" action="productsalesreport.php" method="post">
<center>
  <table width="150" border="0" id="rounded-corner">
  <thead>
<tr align="center">
    <th width="100%" class="rounded-company">Product</th>
    
  </tr></thead>
<tr align="center">
    <td>
    <dd><select size="1" name="pname" id="pname">
  <?php
  $query = "SELECT pname FROM products order by pname";
...
<table align="center" cellpadding="2" cellspacing="2" id="rounded-corner">
<thead>
<tr align="center">
  <th width="14%" class="rounded-company">&nbsp;</th>
    <th width="12%" class="rounded-company">Day</th>
    <th width="12%" class="rounded">Month</th>
    <th width="12%" class="rounded-q4">Year</th>
    <th width="14%" class="rounded-q4">&nbsp;</th>
    <th width="12%" class="rounded-q4">Day</th>
    <th width="12%" class="rounded-q4">Month</th>
    <th width="12%" class="rounded-q4">Year</th>
  </tr>
</thead>
  <tr align="center">
    <td align="right">FROM</td>
    <td><select name="fday" id="fday">
                <?php for($i=1;$i<32;$i++)
			 	{
				 $day = $today['mday'];
				 if($i==$day)
    ...
    <td><select name="fmonth" id="fmonth">
    <?php 
	$month = $today['mon'];
  ...
  <tr align="center">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="submit" name="submit" id="submit" value="View Report" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
