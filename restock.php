...
?>
               ...
               <dl>
                 <dt>
                   <label for="email">Additional Quantity:</label></dt>
                 <dd><input type="text" name="addqty" id="addqty" size="30" /></dd>
               </dl>
               <dl>
                  <table width="100%" border="0" cellspacing="10" cellpadding="10">
                    <tr>
                      <td align="center"><input type="submit" name="submit" id="submit" value="Add Quantity" /></td>
                    </tr>
                  </table>
                </dl>
               </fieldset>
