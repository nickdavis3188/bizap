...
<table id="rounded-corner" summary="">
    <thead>
    	...
    	<tr>
            ...
            <th width="227" class="rounded" scope="col">Staff ID</th>
            <th width="136" class="rounded" scope="col">Incentive Paid</th>
            <th width="84" class="rounded" scope="col">Date</th>
                    
            </tr>
    </thead>
    <?php   
 $query = "select * from  paidincentive order by paiddate";
...
if($noofrows>0)
{
    ...
    { 
	echo("<tr><td>".$count."</td><td>".$row[1]."</td><td>".$row[2]."</td><td>".$row[0]."</td></tr>");
	$count++;
	}
}
?>
        <tfoot>
    	<tr>
        	<td colspan="5" class="rounded-foot-left"><em>This table shows paid incentive..</em></td>
        	</tr>
    </tfoot>
</table>
