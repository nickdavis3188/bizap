    ...
    <div class="logo"><a href="#"><img src="images/logo.gif" alt="" title="" border="0" /></a></div>
         ...
         <div> <center> <?php 
						  ...
						  if (isset($_REQUEST['password']))
						  {
							  ...
							  if($msg=="")
							  { echo ("<div class='error_box'>Your firstname or username is incorrect!!!</div>");}
							  else
							  { echo ("<div class='valid_box'>Your password is ".$msg."</div>");}
						  }
			?>
                    
                    </center></div>
    
         <form action="getpassword.php" method="post" class="niceform">
              ...
              <fieldset>
                  ...
                  <dl class="submit">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                         <td align="center"><input type="submit" name="submit" id="submit" value="Enter" /></td>
                       </tr>
                      </table>
