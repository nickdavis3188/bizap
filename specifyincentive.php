...
<h2>
    ...
    Specify Incentive </h2>
    <?php 
	$query = "select incntv from incentive";
...
?>
         <div class="form">
           <form action="confirmation.php" method="post" class="niceform">
             
             <fieldset>
               <dl>
                 <dt>
                   <label for="email">Incentive (%)</label></dt>
                 <dd><input type="text" name="incentive" id="" size="10" value="<?php echo("$incentiv");?>"/></dd>
               </dl>
