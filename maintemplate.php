...
<h2>     Food and Drink Menu </h2>
    ...
    <thead>
    	<tr>
        	<th width="41" class="rounded-company" scope="col">S/N</th>
            <th width="227" class="rounded" scope="col">Product</th>
            <th width="136" class="rounded" scope="col">Category</th>
            <th width="84" class="rounded" scope="col">Price</th>
            <th width="113" class="rounded" scope="col">Current Level</th>
            
            </tr>
    </thead>
        <tfoot>
    	<tr>
        	<td colspan="5" class="rounded-foot-left"><em>This table shows items currently stocked and their prices.</em></td>
        	</tr>
    </tfoot>
    <tbody>
    	<tr>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tbody>
    	...
    	<tr>
    	  ...
    	  <td><a href="#"><img src="images/photo.png" alt="" title="" border="0" /></a></td>
    	  <td><a href="forgotpword.php" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
  	  </tr>    
