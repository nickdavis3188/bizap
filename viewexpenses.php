...
<div id="main_container">
    ...
    <div class="right_content">            
     <h1>  Expenses Report for a Date Range</h1>   
     
<h2>     Select the date<br />

</h2>
<form id="myform" action="expensesrangereport.php" method="post">
<center>
...
<tr align="center">
  ...
  <tr align="center">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="submit" name="submit" id="submit" value="View Expenses" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
