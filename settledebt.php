...
<h2>
    ...
    Pay Old Debt</h2>
         ...
         <div class="form">
           <form action="settleadebt.php" method="post" class="myform" name="myform" id="myform" onsubmit="return valinput()">
  ...
  <?php
  $query = "SELECT customer FROM debtsummary where totaldebt>0 order by customer";
...
?>
               ...
               <dl>
                  <table width="100%" border="0" cellspacing="10" cellpadding="10">
                    <tr>
                      <td align="center"><input type="submit" name="submit" id="submit" value="Make Payment" /></td>
                    </tr>
                 </table>
               </dl>
             </fieldset>
