...
<div id="main_container">
    ...
    <div class="right_content">            
     ...
     <div class="form">
       <form action="modifyproductrecord.php" method="post" >
             
            <fieldset>
<dl>
 <dt>
                   <label for="gender">Select the record to Modify:</label></dt>
  <dd>
  <select size="1" name="pname" id="">
  <?php
...
?>
                ...
                <dl>
                  <table width="100%" border="0" cellspacing="10" cellpadding="10">
                    <tr>
                      <td align="center"><input type="submit" name="submit" id="submit" value="Edit Record" /></td>
                    </tr>
                  </table>
                </dl>
</fieldset>
