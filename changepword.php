...
<h2>
    ...
    Reset your password</h2>
         ...
         <div class="form">
           <form action="confirmation.php"  id="myform" method="post" class="niceform">
             
             <fieldset>
               <dl>
                 <dt>
                   <label for="email">Username:</label></dt>
                 <dd><input type="text" name="uname" id="" size="30" value="<?php echo("$currentuser");?>" readonly="readonly"/></dd>
               </dl>
                <dl>
                 <dt>
                   <label for="email">New Password:</label></dt>
                 <dd><input type="text" name="newpword" id="" size="30"/></dd>
               </dl>
                <dl>
...
frmvalidator.addValidation("newpword","req","Please enter your new password");
</script>