...
<div id="main_container">
    ...
    <div class="right_content">            
     <h1>Annual Sales Report for <?php echo($dyear); ?></h1>   
...
<table id="rounded-corner" summary="">
 ...
 $query = "select * from  salesreport  where year(fulldate)= '$dyear' order by fulldate";
...
?>
        <?php 
		$query2 = "select SUM(total),SUM(profit) from salesreport where year(fulldate)= '$dyear'";
...
{ 	
	...
	$rangeprofit = $row[1];
        ...
        <tr><td></td><td></td>
        <td><strong>TOTAL FOR THE YEAR</strong></td>
        <td align="center"><strong>#<?php echo($rangetotal);?> .00</strong></td>
        <td align="center"><strong>#<?php echo($rangeprofit);?> .00</strong></td></tr>
        
        
                <?php 
		$query2 = "select SUM(amount) from expenses where year(fulldate)= '$dyear' AND typeofexpense='Recurrent'";
		$results2 = mysql_query($query2);
$noofrows2 = mysql_num_rows($results2);
if($noofrows2>0)
{ 	
	...
	$totalexp = $row[0];
        ...
        <tr><td></td><td></td>
        <td>&nbsp;</td>
        <td align="center"><strong>Total Recurrent Expenses for the Year</strong></td>
        ...
        <tfoot>
    	<tr>
        	<td colspan="5" class="rounded-foot-left"><em>This table shows annual sales report..</em></td>
        	</tr>
    </tfoot>
</table>
